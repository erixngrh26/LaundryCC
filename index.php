...
<body>
    ...
    <div id="carouselControls" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner text-center">
            <div class="carousel-item active">
                <img class="d-block w-100" src="images/laundry121.jpg" alt="Laundry Image 1">
            </div>
    ...
    <div class="jumbotron jumbotron-fluid bg-white">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm">
                    <h6><img src="images/img7.png" width="160px"></h6>
                    <h5>Pembayaran</h5>
    ...
    <div class="jumbotron jumbotron-fluid bg-white">
        <div class="container">
            ...
            <p>Melalui website Laundry Online, Kamu dapat membuat order dengan memilih lokasi Kamu untuk penjemputan dan pengembalian. Setelah itu, kamu pilih layanan yang kamu inginkan, buat order, dan menyelesaikan transaksi pembayaran. Kemudian laundry akan diantarkan di alamatmu.</p>
